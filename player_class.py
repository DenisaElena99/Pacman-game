...
class Player:
    ...
    def draw(self):
       ...
       # (self.grid_pos[0]*self.app.cell_width+TOP_BUTTOM_BUFFER//2,
        #self.grid_pos[1]*self.app.cell_height+TOP_BUTTOM_BUFFER//2,self.app.cell_width, self.app.cell_height), 1)
    ...
    def get_pix_pos(self):
        return vec((self.grid_pos.x*self.app.cell_width)+TOP_BUTTOM_BUFFER//2+self.app.cell_width//2,
        (self.grid_pos.y*self.app.cell_height)+TOP_BUTTOM_BUFFER//2+self.app.cell_height//2)
